...
AFRAME.registerComponent("angle-attribute-setter", {
    ...
    init: function() {
        this.angleCalculator = this.el.components["markers-angle-calculator"];
        this.angleCalculator.el.addEventListener("angle-calculated", (data)=>this.onAngleCalculated(data));
    },
    onAngleCalculated: function(data) {
